...
local InternalSandbox = {
    FakeObjects = setmetatable({},{__mode = "k"}),
    RealObjects = setmetatable({},{__mode = "v"}),
    Environments = setmetatable({},{__mode = "k"}),
    LockedObjects = {},
}
...
local SharedObjects = {
	...
	["NewScript"] = function(Source, Parent)
...
function Sandbox:CreateSandbox(Table, KillFunction, Owner, Script, IsIrc, Channel)
   InternalSandbox.Environments[Table] = {}
   local NewSandbox =  InternalSandbox.Environments[Table]
